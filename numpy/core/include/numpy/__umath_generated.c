...
InitOperators(PyObject *dictionary) {
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[1] = BYTE_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[2] = UBYTE_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[3] = SHORT_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[4] = USHORT_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[5] = INT_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[6] = UINT_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[7] = LONG_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[8] = ULONG_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[9] = LONGLONG_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        equal_functions[10] = ULONGLONG_equal_avx2;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_FMA
    if (NPY_CPU_HAVE(FMA)) {
        floor_functions[1] = FLOAT_floor_fma;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        floor_functions[1] = FLOAT_floor_avx512f;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_FMA
    if (NPY_CPU_HAVE(FMA)) {
        floor_functions[2] = DOUBLE_floor_fma;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        floor_functions[2] = DOUBLE_floor_avx512f;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[1] = BYTE_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[2] = UBYTE_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[3] = SHORT_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[4] = USHORT_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[5] = INT_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[6] = UINT_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[7] = LONG_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[8] = ULONG_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[9] = LONGLONG_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_functions[10] = ULONGLONG_greater_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[1] = BYTE_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[2] = UBYTE_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[3] = SHORT_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[4] = USHORT_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[5] = INT_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[6] = UINT_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[7] = LONG_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[8] = ULONG_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[9] = LONGLONG_greater_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        greater_equal_functions[10] = ULONGLONG_greater_equal_avx2;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[1] = BYTE_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[2] = UBYTE_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[3] = SHORT_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[4] = USHORT_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[5] = INT_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[6] = UINT_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[7] = LONG_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[8] = ULONG_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[9] = LONGLONG_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_functions[10] = ULONGLONG_less_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[1] = BYTE_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[2] = UBYTE_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[3] = SHORT_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[4] = USHORT_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[5] = INT_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[6] = UINT_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[7] = LONG_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[8] = ULONG_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[9] = LONGLONG_less_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        less_equal_functions[10] = ULONGLONG_less_equal_avx2;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        maximum_functions[12] = FLOAT_maximum_avx512f;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        maximum_functions[13] = DOUBLE_maximum_avx512f;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        minimum_functions[12] = FLOAT_minimum_avx512f;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        minimum_functions[13] = DOUBLE_minimum_avx512f;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[1] = BYTE_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[2] = UBYTE_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[3] = SHORT_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[4] = USHORT_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[5] = INT_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[6] = UINT_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[7] = LONG_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[8] = ULONG_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[9] = LONGLONG_not_equal_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (NPY_CPU_HAVE(AVX2)) {
        not_equal_functions[10] = ULONGLONG_not_equal_avx2;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_FMA
    if (NPY_CPU_HAVE(FMA)) {
        rint_functions[1] = FLOAT_rint_fma;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        rint_functions[1] = FLOAT_rint_avx512f;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_FMA
    if (NPY_CPU_HAVE(FMA)) {
        rint_functions[2] = DOUBLE_rint_fma;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        rint_functions[2] = DOUBLE_rint_avx512f;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_FMA
    if (NPY_CPU_HAVE(FMA)) {
        trunc_functions[1] = FLOAT_trunc_fma;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        trunc_functions[1] = FLOAT_trunc_avx512f;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_FMA
    if (NPY_CPU_HAVE(FMA)) {
        trunc_functions[2] = DOUBLE_trunc_fma;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512F
    if (NPY_CPU_HAVE(AVX512F)) {
        trunc_functions[2] = DOUBLE_trunc_avx512f;
    }
    #endif
    ...
    f = PyUFunc_FromFuncAndDataAndSignatureAndIdentity(
        ...
        "DO NOT USE, ONLY FOR TESTING", 0, NULL, identity
    );
    if (0) {
        Py_DECREF(identity);
    }
    ...
    f = PyUFunc_FromFuncAndDataAndSignatureAndIdentity(
        ...
        "Test element-wise for NaN and return result as a boolean array.\n""\n""Parameters\n""----------\n""x : array_like\n""    Input array.\n""out : ndarray, None, or tuple of ndarray and None, optional\n""    A location into which the result is stored. If provided, it must have\n""    a shape that the inputs broadcast to. If not provided or None,\n""    a freshly-allocated array is returned. A tuple (possible only as a\n""    keyword argument) must have length equal to the number of outputs.\n""where : array_like, optional\n""    This condition is broadcast over the input. At locations where the\n""    condition is True, the `out` array will be set to the ufunc result.\n""    Elsewhere, the `out` array will retain its original value.\n""    Note that if an uninitialized `out` array is created via the default\n""    ``out=None``, locations within it where the condition is False will\n""    remain uninitialized.\n""**kwargs\n""    For other keyword-only arguments, see the\n""    :ref:`ufunc docs <ufuncs.kwargs>`.\n""\n""Returns\n""-------\n""y : ndarray or bool\n""    True where ``x`` is NaN, false otherwise.\n""    This is a scalar if `x` is a scalar.\n""\n""See Also\n""--------\n""isinf, isneginf, isposinf, isfinite, isnat\n""\n""Notes\n""-----\n""NumPy uses the IEEE Standard for Binary Floating-Point for Arithmetic\n""(IEEE 754). This means that Not a Number is not equivalent to infinity.\n""\n""Examples\n""--------\n"">>> np.isnan(np.nan)\n""True\n"">>> np.isnan(np.inf)\n""False\n"">>> np.isnan([np.log(-1.),1.,np.log(0)])\n""array([ True, False, False])", 0, NULL, identity
    );
    if (0) {
        Py_DECREF(identity);
    }
    ...
    f = PyUFunc_FromFuncAndDataAndSignatureAndIdentity(
        ...
        "Returns element-wise True where signbit is set (less than zero).\n""\n""Parameters\n""----------\n""x : array_like\n""    The input value(s).\n""out : ndarray, None, or tuple of ndarray and None, optional\n""    A location into which the result is stored. If provided, it must have\n""    a shape that the inputs broadcast to. If not provided or None,\n""    a freshly-allocated array is returned. A tuple (possible only as a\n""    keyword argument) must have length equal to the number of outputs.\n""where : array_like, optional\n""    This condition is broadcast over the input. At locations where the\n""    condition is True, the `out` array will be set to the ufunc result.\n""    Elsewhere, the `out` array will retain its original value.\n""    Note that if an uninitialized `out` array is created via the default\n""    ``out=None``, locations within it where the condition is False will\n""    remain uninitialized.\n""**kwargs\n""    For other keyword-only arguments, see the\n""    :ref:`ufunc docs <ufuncs.kwargs>`.\n""\n""Returns\n""-------\n""result : ndarray of bool\n""    Output array, or reference to `out` if that was supplied.\n""    This is a scalar if `x` is a scalar.\n""\n""Examples\n""--------\n"">>> np.signbit(-1.2)\n""True\n"">>> np.signbit(np.array([1, -2.3, 2.1]))\n""array([False,  True, False])", 0, NULL, identity
    );
    if (0) {
        Py_DECREF(identity);
    }
    ...
    f = PyUFunc_FromFuncAndDataAndSignatureAndIdentity(
        ...
        "Return the element-wise square of the input.\n""\n""Parameters\n""----------\n""x : array_like\n""    Input data.\n""out : ndarray, None, or tuple of ndarray and None, optional\n""    A location into which the result is stored. If provided, it must have\n""    a shape that the inputs broadcast to. If not provided or None,\n""    a freshly-allocated array is returned. A tuple (possible only as a\n""    keyword argument) must have length equal to the number of outputs.\n""where : array_like, optional\n""    This condition is broadcast over the input. At locations where the\n""    condition is True, the `out` array will be set to the ufunc result.\n""    Elsewhere, the `out` array will retain its original value.\n""    Note that if an uninitialized `out` array is created via the default\n""    ``out=None``, locations within it where the condition is False will\n""    remain uninitialized.\n""**kwargs\n""    For other keyword-only arguments, see the\n""    :ref:`ufunc docs <ufuncs.kwargs>`.\n""\n""Returns\n""-------\n""out : ndarray or scalar\n""    Element-wise `x*x`, of the same shape and dtype as `x`.\n""    This is a scalar if `x` is a scalar.\n""\n""See Also\n""--------\n""numpy.linalg.matrix_power\n""sqrt\n""power\n""\n""Examples\n""--------\n"">>> np.square([-1j, 1])\n""array([-1.-0.j,  1.+0.j])", 0, NULL, identity
    );
    if (0) {
        Py_DECREF(identity);
    }
